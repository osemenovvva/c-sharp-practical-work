...
namespace BankSystemWPF.View
{
    ...
    public partial class ConsultantMainPage : Page
    {
        ...
        public ConsultantMainPage(MainWindow mainWindow, LogService logService, DepositAccountRefillService depositAccountRefillService,
        ...
        private void EditClientButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            AddEditClientPage addEditClientPage = new(_service, selectedObject, _mainWindow,
                _logService, _depositAccountRefillService, _noDepositAccountRefillService, _notifications);
